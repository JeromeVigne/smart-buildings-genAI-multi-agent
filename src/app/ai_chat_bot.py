...
from multi_agent_service import triage_agent, weather_agent, energy_agent, building_agent  # Import all agents
...
agent_map = {
    ...
    "Energy Mix Agent": energy_agent,
    "Building Agent": building_agent,
}
